...
# * E-Mail: ediusferreira@gmail.com           *
# * Date: 25-04-2020                          *
# *********************************************
# ======================================================================
...
# Editar sources.list
alias canais='sudo nano /etc/apt/sources.list'
...
# Reparar o apt-get
alias aptreparar='sudo apt-get -f install'
 
# Reparar o dpkg
alias dpkgreparar='sudo dpkg --configure -a'
